...
@Repository
public class JPABedDAO extends GenericJpaDAO<Bed> {
    public JPABedDAO(Class<Bed> modelType) {
        super(modelType);
    }

    public Bed getMatch(Integer price, District district) {
        ...
        CriteriaQuery<Bed> criteriaQuery = builder.createQuery(Bed.class);
